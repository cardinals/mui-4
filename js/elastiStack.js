...
;( function( window ) {
	...
	ElastiStack.prototype._setStackStyle = function() {
		...
		if( item2 ) {
			item2.style.opacity = 0.95;
			item2.style.zIndex = 3;
			setTransformStyle( item2, is3d ? 'translate3d(0,-30px,-60px)' : 'translate(0,0)' );
		}

		if( item3 ) {
			item3.style.opacity = 0.95;
			item3.style.zIndex = 2;
			setTransformStyle( item3, is3d ? 'translate3d(0,-60px,-120px)' : 'translate(0,0)' );
		}
	};
	...
	ElastiStack.prototype._moveAway = function( instance ) {
		...
		var self = this,
			onEndTransFn = function() {
				...
				// reset first item
				setTransformStyle( instance.element, is3d ? 'translate3d(0,-30px,-180px)' : 'translate(0,0,0)' );
