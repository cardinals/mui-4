			...
			if ($.isFunction(self.options.up.callback)) {
				self.pullUpTips = (function() {
					...
					if (!element) {
						...
						element.innerHTML = '<div class="mui-pull-bottom-wrapper" style="display:none;"><span class="mui-pull-loading" style="display:none;">' + self.options.up.contentinit + '</span></div>';
